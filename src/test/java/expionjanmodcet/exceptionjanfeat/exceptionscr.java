...
package expionjanmodcet.exceptionjanfeat;
import pom.exceptiondemopage;
import java.io.File;
...
public class exceptionscr extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new exceptiondemopage(driver).username,"balakrishna@opaltechsolutions.com");
        ...
        try
        {
            actions.EnterData(new exceptiondemopage(driver).password,"Opal@1234");
        ...
        try
        {
            actions.Click(new exceptiondemopage(driver).login);
