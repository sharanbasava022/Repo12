...
package forloopjanmod.ifjanmod;
import pom.homedemopage;
import pom.assertionspage;
import java.io.File;
...
public class ifscr extends  AllActions {
...
String actual;
	...
	catch(Exception e)
	{
        ...
        try
        {
            actual=actions.GetObjectText(new assertionspage(driver).welcometxt);
        ...
        try
        {
            actions.AssertEqualsForString(actual,"Welcome to MeeHappy");
